      ...
      infoSection={{
        ...
        calculationFormula: (
          <>
            ...
            <ul className="list-disc list-inside text-sm space-y-1 mt-2">
              <li>
                <strong>1년 미만 근로자:</strong> 1개월 개근 시 1일의 유급휴가 발생 (최대 11일) <mcreference link="https://work.calculate.co.kr/annual-leave-calculator" index="1"></mcreference>
              </li>
              <li>
                <strong>1년 이상 근로자:</strong> 1년간 80% 이상 출근 시 15일의 유급휴가 발생 <mcreference link="https://www.saramin.co.kr/zf_user/tools/holi-calculator" index="4"></mcreference>
              </li>
              <li>
                <strong>3년 이상 근로자:</strong> 최초 1년을 초과하는 매 2년에 대하여 1일 가산 (최대 25일) <mcreference link="https://www.saramin.co.kr/zf_user/tools/holi-calculator" index="4"></mcreference>
              </li>
              <li>
                <strong>회계연도 기준 계산 시 (입사 다음 연도):</strong> (입사 연도 재직일수 ÷ 365일) x 15 <mcreference link="https://work.calculate.co.kr/annual-leave-calculator" index="1"></mcreference>
              </li>
            </ul>
          </>
        ),
        usefulTips: (
          <>
            <ul className="list-disc list-inside text-sm space-y-1 mt-2">
              <li>
                연차는 발생일로부터 1년 이내에 사용하지 않으면 소멸됩니다. <mcreference link="https://zuzu.network/resource/guide/annual-leave-calculation-method/" index="2"></mcreference>
              </li>
              <li>
                퇴사 시 미사용 연차에 대한 연차수당을 받을 수 있습니다. <mcreference link="https://zuzu.network/resource/guide/annual-leave-calculation-method/" index="2"></mcreference>
              </li>
              <li>
                본 계산기는 모의 계산 결과로 법적 효력이 없으며, 사내 규정에 따라 실제 연차와 차이가 있을 수 있으니 참고용으로 활용하시기 바랍니다. <mcreference link="https://work.calculate.co.kr/annual-leave-calculator" index="1"></mcreference> <mcreference link="https://www.saramin.co.kr/zf_user/tools/holi-calculator" index="4"></mcreference>
              </li>
            </ul>
          </>
        ),
